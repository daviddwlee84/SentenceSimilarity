...
nohup python3 run.py --dataset Ant --word-segment char --model $MODEL --train-embed --logdir $LOGDIR >& /dev/null &
# nohup python3 run.py --dataset Ant --word-segment word --model $MODEL --train-embed --logdir $LOGDIR >& /dev/null &
...
nohup python3 run.py --dataset CCSK --word-segment char --model $MODEL --train-embed --logdir $LOGDIR >& /dev/null &
# nohup python3 run.py --dataset CCSK --word-segment word --model $MODEL --train-embed --logdir $LOGDIR >& /dev/null &
...
nohup python3 run.py --dataset PiPiDai --word-segment char --model $MODEL --train-embed --logdir $LOGDIR >& /dev/null &
# nohup python3 run.py --dataset PiPiDai --word-segment word --model $MODEL --train-embed --logdir $LOGDIR >& /dev/null &
